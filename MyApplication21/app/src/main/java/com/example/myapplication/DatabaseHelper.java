...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean getUser(String name, String description, String phone, String date, String location, String status) {
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(Util.TABLE_NAME, new String[]{Util.ID}, Util.NAME + "=? and "
                        + Util.PHONE + "=? and " + Util.DESCRIPTION + "=? and " + Util.STATUS + "=> and " + Util.DATE + "=? and " + Util.LOCATION + "=?",
                new String[]{name, phone, description, date, location, status}, null, null, null, null);
